...
public class Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface extends Contract {
    ...
    @Deprecated
    protected Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface(
    ...
    public RemoteFunctionCall<Tuple5<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger>> getRoundData(
            BigInteger _roundId) {
    ...
    @Deprecated
    public static Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface load(
            String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice,
            BigInteger gasLimit) {
        return new Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }
    ...
    public static Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface load(
            String contractAddress, Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface load(
            String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return new Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface load(
            String contractAddress, Web3j web3j, TransactionManager transactionManager,
            ContractGasProvider contractGasProvider) {
        return new Src_main_resources_contracts_AggregatorV3Interface_sol_AggregatorV3Interface(contractAddress, web3j, transactionManager, contractGasProvider);
    }
}
