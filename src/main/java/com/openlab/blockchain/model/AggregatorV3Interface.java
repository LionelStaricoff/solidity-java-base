...
public class AggregatorV3Interface extends Contract {
    ...
    @Deprecated
    protected AggregatorV3Interface(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected AggregatorV3Interface(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static AggregatorV3Interface load(String contractAddress, Web3j web3j,
    ...
    public static RemoteCall<AggregatorV3Interface> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return deployRemoteCall(AggregatorV3Interface.class, web3j, credentials, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<AggregatorV3Interface> deploy(Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(AggregatorV3Interface.class, web3j, credentials, gasPrice, gasLimit, getDeploymentBinary(), "");
    }

    public static RemoteCall<AggregatorV3Interface> deploy(Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(AggregatorV3Interface.class, web3j, transactionManager, contractGasProvider, getDeploymentBinary(), "");
    }

    @Deprecated
    public static RemoteCall<AggregatorV3Interface> deploy(Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(AggregatorV3Interface.class, web3j, transactionManager, gasPrice, gasLimit, getDeploymentBinary(), "");
    }
